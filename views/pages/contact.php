<?php
  ...
  if(isset($_POST["btnContact"])){
    ...
    $regexName = "/^[A-Z][a-z]{2,}(\s[A-Z][a-z]{2,})*$/";
    ...
    if(count($errors) > 0){
      ...
      $result = sendMail($name, $email, $subject, $message);
    }
}
...
?>
    ...
    if(isset($_SESSION["sent"])){
          echo "<h3 align='center'>".$_SESSION["sent"]."</h3>";
          unset($_SESSION["sent"]);
      }
    ?>
      ...
      <div class="container">
        ...
        <div class="row block-9">
          <div class="col-md-6 order-md-last d-flex">
            <form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="POST" class="bg-white p-5 contact-form" onSubmit="return contact();">
              ...
              <div class="form-group">
                <input type="submit" value="Send Message" name="btnContact" class="btn btn-primary py-3 px-5">
              </div>
            </form>
