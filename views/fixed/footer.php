        ...
        <div class="row mb-5">
          <div class="col-md">
            <div class="ftco-footer-widget mb-4">
              <h2 class="ftco-heading-2">Paradise Hotel</h2>
            ...
            <div class="ftco-footer-widget mb-4 ml-md-5">
              ...
              <ul class="list-unstyled">
				...
				$query = "SELECT link, m.name FROM role r INNER JOIN menu_role mr ON r.id=mr.id_role 
						...
						WHERE r.id = :id ORDER BY position LIMIT 5";
				...
				<li class="nav-item <?= (basename($_SERVER["PHP_SELF"])==$r->link)?"active" : ""; ?>">
					<a href="<?= $r->link ?>" class="nav-link"><?= $r->name ?></a>
				</li>
				<?php endforeach; ?>
				<?php 
				if(isset($_SESSION["user"])):
          ...
          <div class="col-md">
             <div class="ftco-footer-widget mb-4">
              ...
              <ul class="list-unstyled">
                <li><a href="author.php" class="py-2 d-block">Author</a></li>
